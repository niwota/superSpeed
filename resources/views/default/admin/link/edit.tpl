                            ...
                            <div class="row">
                                <fieldset class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="name" value="{$link->link_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="server" value="{$link->link_uri}">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="type">
                                                <option value="1" {if $link->is_display eq 1} selected="selected" {/if}>显示</option>
                                                <option value="0" {if $link->is_display eq 0} selected="selected" {/if}>隐藏</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="sort" type="number" value="{$link->sort}">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
