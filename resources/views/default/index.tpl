...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br><br>
        <h1 class="header center" style="color:#607D8B !important;">{$config["appName"]}</h1>
        <div class="row center">
            <h5 class="header col s12 light">JUST GO GO</h5>
            {$homeIndexMsg}
        </div>
        {if $user->isLogin}
            <div class="row center">
                <a href="/user" id="download-button" class="btn-large waves-effect waves-light" style="background: #607D8B !important;">进入用户中心</a>
            </div>
        {else}
        <div class="row center">
            <a href="/auth/register" id="download-button" class="btn-large waves-effect waves-light" style="background: #607D8B !important;">立即注册</a>
        </div>
        {/if}
        <br><br>
    </div>
